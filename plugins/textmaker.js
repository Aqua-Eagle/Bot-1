...
Asena.addCommand({pattern: 'textmaker$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    ...
    const msg = command_cmd + '```.textdevil``` \n' + t1 + '_\n' + usage_cmd + '.textdevil Aqua-Snake_\n\n' +
        command_cmd + '```.textbear``` \n' + desc_cmd + t2 + '_\n' + usage_cmd + '.textbear Aqua-Snake_\n\n' +
        command_cmd + '```.textwolf``` \n' + desc_cmd + t10 + '_\n' + usage_cmd + '.textwolf Developer;Aqua-Snake_\n\n' +
        command_cmd + '```.textneon```\n' + desc_cmd + t3 + '_\n' + usage_cmd + '.textneon Aqua-Snake_\n\n' +
        command_cmd + '```.text2neon``` \n' + desc_cmd + t4 + '_\n' + usage_cmd + '.text2neon Aqua-Snake_\n\n' +
        command_cmd + '```.text3neon``` \n' + desc_cmd + t18 + '_\n' + usage_cmd + '.text3neon Aqua-Snake_\n\n' +
        command_cmd + '```.text4neon``` \n' + desc_cmd + t27 + '_\n' + usage_cmd + '.text4neon Aqua-Snake_\n\n' +
        command_cmd + '```.textlight``` \n' + desc_cmd + t5 + '_\n' + usage_cmd + '.textlight Aqua-Snake_\n\n' +
        command_cmd + '```.textjoker``` \n' + desc_cmd + t6 + '_\n' + usage_cmd + '.textjoker Aqua-Snake_\n\n' +
        command_cmd + '```.textninja``` \n' + desc_cmd + t7 + '_\n' + usage_cmd + '.textninja Developer;Aqua-Snake_\n\n' +
        command_cmd + '```.textglitter``` \n' + desc_cmd + t8 + '_\n' + usage_cmd + '.textglitter Aqua-Snake_\n\n' +
        command_cmd + '```.textbokeh``` \n' + desc_cmd + t9 + '_\n' + usage_cmd + '.textbokeh Aqua-Snake_\n\n' +
        command_cmd + '```.textmarvel``` \n' + desc_cmd + t11 + '_\n' + usage_cmd + '.textmarvel Developer;Aqua-Snake_\n\n' +
        command_cmd + '```.text2marvel``` \n' + desc_cmd + t12 + '_\n' + usage_cmd + '.text2marvel Developer;Aqua-Snake_\n\n' +
        command_cmd + '```.textavengers``` \n' + desc_cmd + t13 + '_\n' + usage_cmd + '.textavengers Developer;Aqua-Snake_\n\n' +
        command_cmd + '```.textgraf``` \n' + desc_cmd + t15 + '_\n' + usage_cmd + '.textgraf Developer;Aqua-Snake_\n\n' +
        command_cmd + '```.text2graf``` \n' + desc_cmd + t16 + '_\n' + usage_cmd + '.text2graf Developer;Aqua-Snake_\n\n' +       
        command_cmd + '```.textlion``` \n' + desc_cmd + t17 + '_\n' + usage_cmd + '.textlion Developer;Aqua-Snake_\n\n' +
        command_cmd + '```.textice``` \n' + desc_cmd + t19 + '_\n' + usage_cmd + '.textice Aqua-Snake_\n\n' +
        command_cmd + '```.textspace``` \n' + desc_cmd + t20 + '_\n' + usage_cmd + '.textspace Developer;Aqua-Snake_\n\n' +
        command_cmd + '```.textsmoke``` \n' + desc_cmd + t21 + '_\n' + usage_cmd + '.textsmoke Aqua-Snake_\n\n' + // Thanks for @Unique_hunter for base.
        command_cmd + '```.textglow``` \n' + desc_cmd + t23 + '_\n' + usage_cmd + '.textglow Aqua-Snake_\n\n' +
        command_cmd + '```.textfire``` \n' + desc_cmd + t25 + '_\n' + usage_cmd + '.textfire Aqua-Snake_\n\n' +
        command_cmd + '```.textharry``` \n' + desc_cmd + t26 + '_\n' + usage_cmd + '.textharry Aqua-Snake_\n\n' +
        command_cmd + '```.textcup``` \n' + desc_cmd + t29 + '_\n' + usage_cmd + '.textcup Aqua-Snake_\n\n' +
        command_cmd + '```.textcemetery``` \n' + desc_cmd + t28 + '_\n' + usage_cmd + '.textcemetery Aqua-Snake_\n\n' +
        command_cmd + '```.textglitch``` \n' + desc_cmd + t14 + '_\n' + usage_cmd + '.textglitch Developer;Aqua-Snake_'
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/devil.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/devil.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/bear.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/bear.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/wolf.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/wolf.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/neon.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/neon.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/neon2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/neon2.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/li.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/li.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/joker.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/joker.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/ninja.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/ninja.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/tt.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/tt.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/bkh.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/bkh.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/marvel.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/marvel.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/mar2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/mar2.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/aven.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/aven.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/tt2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/tt2.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/ttgra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/ttgra.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/t2gra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/t2gra.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/lion.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/lion.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/neon3.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/neon3.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/ice.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/ice.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/space.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/space.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/smoke.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/smoke.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Asena.addCommand({pattern: 'textglow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    await download(`https://api.xteam.xyz/photooxy/neonlight?text=${uri}&APIKEY=da5fb2b73ae3e451`, '/root/CBot/glowttp.jpg', async() => {                          
        await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/glowttp.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
    })
}));
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/tfire.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/tfire.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/hp.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/hp.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/t4n.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/t4n.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/cmth.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/cmth.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/CBot/cup.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/CBot/cup.jpg'), MessageType.image, { caption: 'Made by Cyber Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
